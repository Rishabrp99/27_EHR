...
from fastapi import APIRouter, Response, status, Depends, HTTPException,Depends
...
async def create_user(payload: schemas.CreateUserSchema,response:Response):
    ...
    response.set_cookie('user_id', new_user["id"], ACCESS_TOKEN_EXPIRES_IN * 60,
...
def login(payload: schemas.LoginUserSchema, response: Response, Authorize: AuthJWT=Depends()):
    ...
    response.set_cookie('logged_in', 'True', ACCESS_TOKEN_EXPIRES_IN * 60,
                        ACCESS_TOKEN_EXPIRES_IN * 60, '/', None, False, False, 'lax')
    response.set_cookie('user_id', user["id"], ACCESS_TOKEN_EXPIRES_IN * 60,
                        ACCESS_TOKEN_EXPIRES_IN * 60, '/', None, False, False, 'lax')
